...
The Gowin IDE keeps what to build in tang/bk.gprj, and its headless
...
IDE last wrote:  top module `top`, SystemVerilog 2017 (zs256/ym2149.sv needs
...
def main():
    ...
    cfgp = os.path.join(ROOT, "tang", "impl", "bk_process_config.json")
