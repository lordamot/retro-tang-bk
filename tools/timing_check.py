...
Reads tang/impl/pnr/bk_tr_content.html and bk.log and exits
...
BK Nano has one internal clock (clk64) and nothing derived from a
...
TR   = PNR / "bk_tr_content.html"
LOG  = PNR / "bk.log"

REQUIRED_CLOCKS = ["clk27", "clk64", "spi_clk"]
