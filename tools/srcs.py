...
tang/bk.gprj is the source of truth for what gets built (see
...
GPRJ = os.path.join(ROOT, "tang", "bk.gprj")
...
# simulating a 210 MHz serial clock for the whole run would cost a great
