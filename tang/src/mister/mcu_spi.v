...
module mcu_spi (
  ...
  output       mcu_az_strobe,  // byte strobe for the AZ controller target (azctrl.v)
  output       mcu_start,
  input  [7:0] mcu_sys_din,
  input  [7:0] mcu_hid_din,
  input  [7:0] mcu_osd_din,
  input  [7:0] mcu_sdc_din,
  input  [7:0] mcu_az_din,
  output [7:0] mcu_dout
);
...
assign mcu_az_strobe  = spi_in_strobe && spi_target == 8'd4;
