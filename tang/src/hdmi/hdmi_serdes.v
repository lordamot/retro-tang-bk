...
// 64.8 MHz x 5 = 324 MHz.  VCO = 324 x 2 = 648 MHz, inside the GW2A
// range; the phase detector sees the full 64.8 MHz.  (ZS-256 Nano ran
// this at 210 from 42, Korvet Nano at 202.5 from 40.5.)  Parameters
