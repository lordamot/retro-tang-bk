...
#define SPI_SYS_POKE      6   // ZS-256: a 24-bit address and bytes into the SDRAM (romload.c); PK8000's has two address bytes
#define SPI_SYS_DEBUG     7   // the debug window (top.v's dbg bus) - an offset, then bytes
#define SPI_SYS_PEEK      8   // BK Nano: a 32-bit word out of the SDRAM at a 24-bit byte address (sys_peek24)
